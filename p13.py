...
print(min(c_list)) # 1 
print(max(c_list)) # 9
# Access individual characters/items in a list + Access the first, access the last item in a list
...
# Sort a list
# Sort two lists where the index are attached to each other based on 